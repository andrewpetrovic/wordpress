...
if (is_home() || is_page()) {
   ...
   $description = "A.J. の 小站";

   // 将以下引号中的内容改成你的主页keywords
   $keywords = "WordPress,blog,coding,php,A.J.";
}
elseif (is_single()) {
...
<link rel="alternate" type="application/rss+xml" title="RSS 2.0 - 所有迴響" href="<?php bloginfo('comments_rss2_url'); ?>" />
<?php wp_head(); ?>
</head>
<?php flush(); ?>
<body>
