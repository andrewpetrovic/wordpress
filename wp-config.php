 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         '-G4u/yn j<)ea/Sf@/k&DUe1v|E,t8IH}UgSvEot)q%{0,>7~snY<kb6s|>}QXw^');
define('SECURE_AUTH_KEY',  'lgLZ|DtP0u&|*C UH|m8A/nM6D/iPj;X0)M8V ,|+mz=WB25+-bArN~@PWwGTy|4');
define('LOGGED_IN_KEY',    'b$Z|3hVh-FW;vLvj%U_@)Ve]kQ>uP}9V-7R?1lU;u^^M=>;i@<pGo(ZjcB%Or{/i');
define('NONCE_KEY',        '13f6%=V+luh!>9!b=5;>x||N}ar**IKLj:@$A+dh{gRynHIfvN>.VzRo6Rov,M1m');
define('AUTH_SALT',        '8kr=IwrM&#B tcp>16^JnyHrW3>d9Yhj~Q=g.@ga#S.pWlPcK3]n#K;|>]HBR|x$');
define('SECURE_AUTH_SALT', 'U<giz/,wc-|z/_4W4q/AMnU4?N+hDpo-7j-n{DxDBvhI|?=[ez;+9hXNxcQZa%(|');
define('LOGGED_IN_SALT',   'vHWkqb|KKH{a~A{s!i+4}|FCL91Ym~({~C+({#7KGK10r#n/<G+(,5+TmHt o9-8');
define('NONCE_SALT',       'bsw/A*b[5^7[DGw3tFV+_gT|BxP%!wdeDwTmX<|]8~n+K,6ohG93UdMyAwZMwx&.');
